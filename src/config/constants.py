...
class ConfigKeys:
    ...
    LEGACY_KEYS = {
        ...
        "DOC_RECORD": "Doc_record",
        "DOC_STD": "DOC_STD",            # FIX #3: Was "doc_number" which doesn't match actual config keys
        "STD_NAME": "STD_name",
...
class XmlTags:
    ...
    CELL_WIDTH = "w:tcW"
    GRID_SPAN = "w:gridSpan"          # FIX #8: Explicit constant instead of string surgery
    V_MERGE = "w:vMerge"              # FIX #8: Explicit constant instead of hardcoded string
